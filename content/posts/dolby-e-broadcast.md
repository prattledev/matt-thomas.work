...
Dolby E frames are locked to video frame boundaries, which is fundamental to why it works in broadcast infrastructure. The audio frame and the video frame travel together through the SDI chain, through satellite uplinks, through distribution networks, without the two ever drifting apart.
